...
const SaleCard = ({
  ...
  return (
    <div className={`w-full bg-white dark:bg-darkgrey shadow-lg dark:shadow-black border border-gray-200 dark:border-gray-600 rounded-2xl p-4 sm:p-6 ${className} relative`}>
      <div className="flex justify-between items-center mb-4">
        <h1 className="font-semibold text-neutral-700 dark:text-lightPrimary text-lg sm:text-xl">
          {title}
        </h1>
        <img src={image} alt="saleImage" className={`absolute ${imageClassName}`} />
      </div>
