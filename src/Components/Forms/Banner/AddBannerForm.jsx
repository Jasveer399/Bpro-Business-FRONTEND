      ...
      <div>
        <form onSubmit={handleSubmit(addBannerHandler)} className="px-16 mt-4 space-y-4">
          ...
          <div className="flex items-center gap-4 px-2">
            ...
            <label className={`flex items-center gap-2 px-2 py-1 rounded-full cursor-pointer ${
              watchStatus === 'active' ? 'bg-green-200 text-green-800 border-2 border-green-400' : 'bg-green-200 text-green-800'
            }`}>
              <input
                type="radio"
                value="active"
            ...
            <label className={`flex items-center gap-2 px-2 py-1 rounded-full cursor-pointer ${
              watchStatus === 'inactive' ? 'bg-red-200 text-red-800 border-2 border-red-400' : 'bg-red-200 text-red-800'
            }`}>
              <input
                type="radio"
                value="inactive"
