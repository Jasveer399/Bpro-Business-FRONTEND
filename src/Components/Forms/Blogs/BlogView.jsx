...
const BlogView = () => {
  ...
  if (status === "loading") {
    return (
      <div className="flex justify-center h-full items-center dark:bg-darkPrimary text-colorText2 dark:text-colorText">
        Loading...
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="text-red-500 h-full text-center dark:bg-darkPrimary">
        Error: {error}
      </div>
    );
  }
  ...
  if (!currentBlog) {
    return (
      <div className="text-center dark:bg-darkPrimary text-colorText2 dark:text-colorText h-full">
        Blog not found
      </div>
    );
  }
  ...
  return (
    <div className="w-full h-full px-20 pt-24 pb-10 overflow-y-auto dark:bg-darkPrimary text-colorText2 dark:text-colorText custom-scrollbar">
      ...
      <Typography
        variant="body1"
        className="text-lg leading-relaxed mb-8 text-gray-700 dark:text-gray-200"
