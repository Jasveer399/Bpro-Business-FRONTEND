  ...
  (
    ...
    <div className={width}>
      <div className="relative">
        {label ? <h1 className="text-[15px] text-gray-600">{label}</h1> : null}
        <select
          ref={ref}
          className={`w-full px-3 py-2.5 bg-white rounded-md focus:outline-none transition-shadow duration-200 ease-in-out
                    ${
                      disabled
