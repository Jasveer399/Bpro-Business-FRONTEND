...
function Blogs() {
  ...
  return (
    <div
      className="w-full  h-full pt-16 dark:bg-darkPrimary dark:text-darkTextGreyColor text-neutral-800 px-5 overflow-y-auto font-montserrat
        "
    >
      <div className="w-full flex justify-between pt-5 px-10">
        ...
        <Dialog
          trigger={
            <button className="bg-blue rounded-md py-1 px-3 flex justify-center font-semibold text-white gap-2">
              Add Blogs
            </button>
          }
          width="w-[80%]"
