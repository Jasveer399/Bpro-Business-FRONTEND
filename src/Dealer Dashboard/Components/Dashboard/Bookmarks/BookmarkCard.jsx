...
//       <div>
//         <img
//           src={item.images?.[0] || "/search1.png"}
//           className="rounded-t-md w-full"
//           alt={item.title}
//         />
//       </div>

//       {/* Rest of the card remains the same as before */}
//       <div className="flex items-center justify-between my-2">
//         <div className="flex items-center gap-1">
//           <img
//             src={item.categoryIcon || "/cardIcon.png"}
//             className="w-5"
//             alt="Category"
//           />
//           <p className="text-[#6A6A6A] mt-1 text-sm">
//             {item.category || "Lift & Elevators"}
//           </p>
//         </div>
//         <div className="flex items-center text-[#00BCE7]">
//           <VscVerifiedFilled size={20} />
...
//           {item.title || "Dumbwaiter Elevators"}
//         </h1>
//       </div>
//       <div className="flex items-center my-1">
//         <IoLocationSharp className="text-secondary" size={16} />
//         <p className="text-[#6A6A6A] text-xs">
//           {item.location || "Kharghar Road Kharghar, Navi Mumbai"}
//         </p>
//       </div>
//       <div className="flex items-center gap-2 my-2">
//         <div className="flex items-center gap-1 bg-secondary py-[2px] px-2 rounded-md">
//           <p className="font-semibold text-sm mt-px">{item.rating || "4.4"}</p>
//           <FaStar className="text-white" size={14} />
//         </div>
//         <p className="text-[#6A6A6A] text-sm">
//           {item.ratingCount || "15"} Ratings
//         </p>
//       </div>
//       <div className="flex items-center gap-2">
//         <button className="bg-[#29AF3E] px-3 py-1 rounded-md text-white font-semibold border border-[#29AF3E]">
