...
function DealerProfileCard() {
  ...
  return (
    <div className="w-full">
      ...
      >
        {dealers?.map((dealer) => (
          <SwiperSlide key={dealer.id} onClick={() => navigate(`/dealerProfile/${dealer.id}`)}>
            <div className="flex flex-col  items-center h-60 p-3 border">
              <img
              ...
              <h1 className="text-sm text-gray-600">{dealer?.Category?.title}</h1>
