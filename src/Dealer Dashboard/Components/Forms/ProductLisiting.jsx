...
function ProductLisiting() {
  ...
  return (
    <>
      ...
      <h1 className='flex flex-col md:text-6xl text-4xl font-semibold text-white absolute top-40 md:left-20 left-5 gap-4'>Product Lisiting <span className='text-xl'>Home | Product Lisiting</span></h1>
      <div className='mx-52 mt-20'>
        <h1 className='text-4xl font-bold text-center'>Create New listing</h1>
        <form className='flex flex-col gap-10' onSubmit={handleSubmit(addProductLisitingHandler)} >
          <div className='w-full border border-gray-400 dark:border-gray-600 pb-4 sm:pb-6 mt-5 text-neutral-700 flex justify-center items-center flex-col gap-8 '>
            <h1 className='text-xl font-bold border-b border-gray-200 dark:border-gray-600 py-4 px-8 w-full'>General Details</h1>
            <FormInput
              label="Title"
              type="text"
              {...register("title", {
            ...
            <h1 className='text-[17px] font-semibold dark:border-gray-600 px-16 w-full flex flex-col gap-4'>
              ...
              <span className='text-sm text-gray-400'>Regular users can not change expiration date. This option is available only for admins.<br /> <br />Set new expiration date and time of the listing.<br />
                Be careful: If you'll set past date - listing will expire in some minutes.</span>
            </h1>
          ...
          <div className='w-full border border-gray-400 dark:border-gray-600 pb-4 sm:pb-6 mt-5 text-neutral-700 flex justify-center items-center flex-col gap-8 '>
            ...
            <div className='flex gap-10 w-[90%]'>
              <div className='w-full flex'>
                <FaArrowUpRightFromSquare size={50} className='border-2 border-y p-4 border-gray-400 rounded-l-md mt-[1.46rem] text-gray-500' />
                <FormInput
                  label="Url"
                  type="text"
                  {...register("url", {
              ...
              <div className='w-full flex'>
                <TbView360 size={50} className='border-2 border-y p-3 border-gray-400 rounded-l-md mt-[1.46rem] text-gray-500' />
                <FormInput
                  label="View Our Site"
                  type="text"
          ...
          <div className='w-full border border-gray-400 dark:border-gray-600 pb-4 sm:pb-6 mt-5 text-neutral-700 flex justify-center items-center flex-col gap-8 '>
            <h1 className='text-xl font-bold border-b border-gray-200 dark:border-gray-600 py-4 px-8 w-full'>Media</h1>
